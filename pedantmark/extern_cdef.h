...
typedef void (*pedant_render_node_t)(cmark_strbuf *buf, cmark_node *node, const char *text, int options, void *userdata);
...
extern "Python" void pedant_render_node(cmark_strbuf *, cmark_node *, const char *, int, void *);
